...
//		VALIDACION
	...
	@Test         //#7
	public void QueSePuedaMOstrarRankingarticipantes() throws DisparoInvalidoException {
//		PREPARACION
		
		Integer numeroParticipante=1,coordX=3,coordY=42,coordX1=5,coordY1=25,coordX2=8,coordY2=1,//puntaje participante1=1250
				numeroParticipante2=2,coordX00=3,coordY00=5,coordX11=5,coordY11=6,coordX22=8,coordY22=1,//puntaje participante2=3000
				numeroParticipante3=3,coordX000=25,coordY000=25,coordX111=25,coordY111=26,coordX222=28,coordY222=21,//puntaje participante2=1500
				codigoTorneo=123123123;
		NumeroOrdinalDisparo orden = NumeroOrdinalDisparo.PRIMERO,orden1 = NumeroOrdinalDisparo.SEGUNDO,
				orden2 = NumeroOrdinalDisparo.TERCERO;
		String nombreTorneo="Olympic";
...
//		EJECUCION
		...
		Collections.sort(torneo.getRanking());	
		
		torneo.printRanking(torneo.getRanking());
...
//		VALIDACION
		...
		Integer ve=participante3.getNumeroParticipante();
		Integer vo= torneo.getRanking().get(0).getNumeroParticipante();
		assertEquals(ve,vo);
